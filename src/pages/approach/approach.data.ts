...
export const PRINCIPLES: readonly Principle[] = [
  ...
  },
  {
    ...
    body: "The experience is a holistic constellation: policies, operations, data and service lines all participate in shaping “the product”. The real craft is weaving them all together.",
  },
  {
...
export const FAQS: readonly Faq[] = [
  ...
  },
  {
    ...
    answer:
      "The future is unknown and plural, but organisations still need to commit and deliver under uncertainty. Designing a product vision means questioning inherited assumptions and having the judgment to create the agency to shape what comes next. I start by aligning many interdependent things across the product ecosystem, from business needs and aspirations to key operationally problematic areas, trends, and foresights. What do all of these have in common, where do they diverge, and how do they shape the future of the product or the company? How are the proposed product experiences built over time, and will they make sense not only in today’s ideals, but also in tomorrow’s landscape?",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Designers without direction are at risk of becoming designers without purpose. I mentor through listening, challenging and direction. I help designers strengthen their judgement and articulate decisions clearly and confidently. I hold weekly 1:1s focusing on progress, motivation and specific areas of individual growth.",
  },
];
